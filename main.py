...
pages = pdf_reader.pages[122:133]
text = ""
for page in pages:
...
for match in matches:
    ...
    if "kinyarwanda" not in questions[q_num]:
        questions[q_num]["kinyarwanda"]={"question":question,"options":options_dict}
    elif "english" not in questions[q_num]:
        questions[q_num]["english"]={"question":question,"options":options_dict}
    elif "french" not in questions[q_num]:
        questions[q_num]["french"]={"question":question,"options":options_dict}
